    ...
    <>
      <nav className={`navbar navbar-expand bg-${props.mode}`}>
        <div className="container-fluid">
          <Link className={`nav-link text-${invertTheme(props.mode)}`}   to="/">{props.title}</Link>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              <li className="nav-item">
                <Link className={`nav-link text-${invertTheme(props.mode)}`} aria-current="page" to="/">Home</Link>
              </li>
              <li className="nav-item">
                <Link className={`nav-link text-${invertTheme(props.mode)}`} to="/about">About</Link>
              </li>
            </ul>
